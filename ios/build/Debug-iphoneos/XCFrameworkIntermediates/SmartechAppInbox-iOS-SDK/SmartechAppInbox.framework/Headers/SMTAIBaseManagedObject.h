//
//  SMTAIBaseManagedObject.h
//  SmartechAppInbox
//
//  Created by Netcore Solutions on 13/11/20.
...
@interface SMTAIBaseManagedObject : NSManagedObject
 ...
 */
+ (NSFetchRequest <SMTAIBaseManagedObject *> *)fetchRequest;
...
+ (NSArray *)findObjectsWithDistinct:(NSPredicate * _Nullable)predicate
                           inContext:(NSManagedObjectContext *)context;
