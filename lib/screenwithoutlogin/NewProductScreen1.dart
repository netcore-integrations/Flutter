...
class NewProductScreen1 extends StatefulWidget {
  StoreData category;

  NewProductScreen1(this.category);
  @override
  State<NewProductScreen1> createState() => _NewProductScreen1State();
}

class _NewProductScreen1State extends State<NewProductScreen1> {
