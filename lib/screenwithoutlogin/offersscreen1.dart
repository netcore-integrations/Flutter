...
import '../presentation/drawermenuitems/offers/Model/OffersModel.dart';

class OffersScreen1 extends StatefulWidget {
  // otp.Data data;
  //
  // OffersScreen1(this.data);

  @override
  State<OffersScreen1> createState() => _OffersScreen1State();
}

class _OffersScreen1State extends State<OffersScreen1> {
