...
class AfterScrollItemWidget extends StatelessWidget {
  AfterScrollItemWidget(this.afterScrollItemModelObj);

  AfterScrollItemModel afterScrollItemModelObj;

  var controller = Get.find<AfterScrollController>();
