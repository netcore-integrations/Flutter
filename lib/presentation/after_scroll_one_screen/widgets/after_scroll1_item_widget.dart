...
class AfterScroll1ItemWidget extends StatelessWidget {
  AfterScroll1ItemWidget(this.afterScroll1ItemModelObj);

  AfterScroll1ItemModel afterScroll1ItemModelObj;

  var controller = Get.find<AfterScrollOneController>();
