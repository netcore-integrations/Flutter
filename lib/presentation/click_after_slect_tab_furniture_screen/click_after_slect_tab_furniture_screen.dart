...
class ClickAfterSlectTabFurnitureScreen extends StatefulWidget {
  Data data;
  StoreData category;
  String category_name;
  // SubCategory subcategory;
  ClickAfterSlectTabFurnitureScreen(
      this.data, this.category, this.category_name);
  @override
  State<ClickAfterSlectTabFurnitureScreen> createState() =>
      _ClickAfterSlectTabFurnitureScreenState();
}

class _ClickAfterSlectTabFurnitureScreenState
    extends State<ClickAfterSlectTabFurnitureScreen> {
